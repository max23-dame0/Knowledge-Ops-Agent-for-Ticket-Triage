...
| # | 任务 | 阶段 | 状态 | 下一步 | 阻塞 |
|:--:|------|------|:--:|------|------|
| 1 | 外部数据集评测（prompt-injections/clinc_oos 下载 + 评测脚本 + 报告） | 已完成 | ✅ 已提交（dc81f39/fd25830） | P2 建议（空证据降级/误伤细分）可选推进 | 无 |
| 2 | P1 加固（fallback kb→clarify + 多语种注入检测） | 已完成 | ✅ 已提交（dc81f39） | 复测：注入拒答 100%、幻觉风险 0 | 无 |
